...
namespace IMedia9
{
    ...
    public class Shooter3DDpad : MonoBehaviour
    {
        ...
        public class CBullet3D
        {
            ...
            public DPadTouchAction TriggerButton;
        ...
        void Update()
        {
            ...
            {
                if (Bullet3D[ActiveBulletIndex].isEnabled && Bullet3D[ActiveBulletIndex].TriggerButton.isActionButtonUp() && !isCooldown)
                {
                    isCooldown = true;
            ...
            if (TriggerMode == CForceTrigger.TriggerByKey)
                {
                    ...
                    {
                        if (Bullet3D[i].isEnabled && Bullet3D[i].TriggerButton.isActionButtonUp() && !isCooldown)
                        {
                            isCooldown = true;
                            ActiveBulletIndex = i;
